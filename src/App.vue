...
<template>
  <div class="navbar navbar-dark bg-primary bg-gradien shadow" style="height : 50px">
    <div class="container">
  ...
  <div class="d-flex flex-column flex-shrink-0 bg-light shadow" style="width: 4.5rem;height: calc(100% - 50px) ;">
    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      <li class="nav-item">
        <a href="#" class="nav-link active py-3 border-bottom" aria-current="page" title="Home" data-bs-toggle="tooltip"
          data-bs-placement="right">
