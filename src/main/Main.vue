...
import ShareViewItem from './components/ShareView/ShareViewItem.vue'
...
<template>
  ...
  <div class="d-flex w-100" style="height: calc(100% - 36px) ;">
    <SidebarItem style="z-index: 2;" @setView="setView" />
    <ShareViewItem v-if="viewflag == constant.enum.viewFlag.Share" />
