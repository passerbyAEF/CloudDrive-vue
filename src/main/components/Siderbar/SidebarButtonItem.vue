...
<template>
    <a href="javascript:;">
        <div class="nav-link border-bottom">
            <svg t="1661841446897" class="icon" viewBox="0 0 1228 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="944" width="100%" height="100%">
                <path
